...
\thispagestyle{plain}
  ...
  \mypar{Right neighbor paths}
    ...
    \begin{proof}
      ...
      Due to the order in which we added vertices to $Q'$, which is preserved by the removal of vertices when we go to $Q$, we know that any vertices inbetween $q_i$ and $q_j$ in $Q$ must be one of the following:
      \begin{enumerate}
    ...
    \begin{proof}
      ...
      $q$ Was added as right neighbor of some interior vertex $p$ of $P$.
