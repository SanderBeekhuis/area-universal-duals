...
\subsection{Phase 2}
  ...
  We will work from the last created face upwards. When doing a flip we try to only alter the history, not the current face and certainly not the future. We will treat flips under a topfan of size 4 differntly, because we don't have the space to execute all standard flips.

  \paragraph{The standard flips}
  Figures of the basic same and opposite orientation flips.
   See Figure \ref{fig:uni:sameFlip} and \ref{fig:uni:oppFlip}.
