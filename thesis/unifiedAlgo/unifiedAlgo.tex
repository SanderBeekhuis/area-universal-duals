...
We first do a flip turning every same orientation chain of Z's to an opposite orientation one. Then we do a flip breaking an opposite orientation chain. We do this for every chain of $Z$'s created when entombing the topfans.  \fxwarning{TODO define entomb and find a better word for it}
