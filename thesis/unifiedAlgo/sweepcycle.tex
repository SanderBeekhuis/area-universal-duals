...
\thispagestyle{plain}
  ...
  One of the nicest things about the \rel we produce is Lemma \ref{lm:sweep:NoTwoSplitsAboveEachOther} which will turn out to be very useful throughout the rest of the algorithm. \fxnote{Is this due to the last invariant?}
