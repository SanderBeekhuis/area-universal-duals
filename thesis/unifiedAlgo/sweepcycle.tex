...
\section{Flipping Blue $Z$'s}
    ...
    \begin{proof}
      ...
      The edges of $\P$ and $ab$ can not have been flipped since then we would find a monocolored red triangle while a flip leads to another valid \rel. Hence $w$ is still on the bottom path trough $v$ and still can not be the handle of a large topfan.
    \end{proof}
