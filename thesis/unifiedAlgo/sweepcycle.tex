...
\subsubsection{Evade chords and separating 2-chords}
  ...
  By \emph{violating chords}, we mean these two classes of structures together and the \emph{middle} vertex of a $2$-chord is the only internal vertex of that $2$-chord.
  ...
  \mypar{We have a chord on $\mathbf{P}$}
    ...
    \emph{At least one separating 2-chord.}
      ...
      That leaves violating chords within the second endpoint inside containing chord $p_i p_j$. \fxnote{TODO make this a complete cycle}
