...
\section{Sweepcycle algorithm}
  ...
  \subsection{Irregularities}
    ...
    \begin{proof}
      ...
      \fxerror{I don't thinks this is true, it can also be adjacent to the topmost fan. (Note we must use the idiom that a split splits off to the bottom and a merge merges to the top)}
