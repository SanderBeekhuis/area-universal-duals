...
\section{Sweepcycle algorithm}
  ...
  \subsection{Irregularities}
    ...
    \paragraph{We have no irregularity}
      ...
      However since $v_i$ and $v_j$ are both adjacent to $\pS$ we see that $C$ has to be a $2$-chord with $\pS$ as middle vertex. However these are allowed for Invariant \ref{i:uni:no2Chords}.
