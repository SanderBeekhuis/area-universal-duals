...
\subsubsection{Evade chords and separating 2-chords}
  ...
  By \emph{irregularities}, we will mean these two classes of structures together and the \emph{middle} vertex of a $2$-chord is the only interior vertex of that $2$-chord.
