...
\mypar{Regular edge labellings}
  ...
  \fxnote*{Do we use this anywhere? If so we should proof it.}{A regular edge labeling has no monochromatic directed cycles because such a cycle would for example correspond to a  group of adjacent rectangles that have  no leftmost or topmost rectangle.}
