...
\fxnote{restructre, less numerbered headings}
\fxnote{Lead in paragrah}
...
\subsection{Different kinds of rectangular layouts}
  ...
  Eppstein et al. \cite{Eppstein2012} show that a layout is area-universal if and only if it is one-sided. \fxnote{We could build more context}
...
\subsection{Corner assignments}
  ...
  \begin{thrm}[Existence of a rectangular dual]
    ...
    \fxnote{Q how should this be done diffently}
  \end{thrm}
