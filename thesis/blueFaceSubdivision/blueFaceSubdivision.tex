...
We will start at the bottommost face $F$ in the creation order (which we will have to recalculate after the topfanflips, but every REL has one). And we will recolor some of its edges if it is too large. \fxnote{I may need to expand a bit more on this order}
