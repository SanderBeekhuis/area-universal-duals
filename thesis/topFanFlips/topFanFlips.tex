...
\section{Algorithm}
Note that we shrink any chord or any polebound 2-chord as described in the previous section. \fxwarning{TODO ref}. We then have a vertical one-sided rel with all starts along the south border. We can thus librally use topfan flips on all topfans.
