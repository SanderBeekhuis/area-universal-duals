...
\mypar{Rectangular layout}
  ...
  We will call any such line segment that is not extended any farther on either side a \emph{maximal segment}.
...
\mypar{Graphs}
  ...
  All graphs in this thesis will be \emph{triangulations of the $k$-gon}. A triangulation of the $k$-gon has an outer face of degree $k$ and interior faces of degree $3$.
...
\mypar{Results}
  ...
  We can imagine this in the following way, we will compare a $2$-sided and a $10$-sided segment. Let us first consider the an example of a $2$-sided segment in Figure \ref{fig:intro:2sidedBefore},  if we double the size of $a$ only two adjacencies change, namely $dA$ and $cB$, as can been seen in Figure \ref{fig:intro:2sidedAfter}.
