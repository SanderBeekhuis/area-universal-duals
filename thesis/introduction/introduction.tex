...
\mypar{Rectangular layout}
  ...
  A rectangular layout that has an \emph{combinatorially equivalent} layout, regardless the area sizes we assign to each rectangle is \emph{area-universal}. An example of an area-universal layout is given by the three combinatorially equivalent layouts in Figure \ref{fig:intro:areaunivLayout}.
