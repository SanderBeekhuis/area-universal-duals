...
\mypar{Motivation}
  ...
  \end{figure}
  In for example atlases \emph{rectangular cartograms} are used to display information, such as population or economic strength, in a spatial manner. Raisz~\cite{Raisz1934} introduced these cartograms and gave examples of, for instance, land area, population (see Figure  \ref{fig:intro:raisz}) and wealth of the United States of America.
  ...
  The value of the displayed quantity can change over time.
  Hence, when drawing several cartograms of a quantity the size of each region will change according to the moment in time.
