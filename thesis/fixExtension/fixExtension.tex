...
Fortunately for us however we can view $\ext G = H$ as a graph in it's own right, then $G$ is the interior of a separating $4$-cycle of $H$ and we will show this implies that $G$ (as induced sugraph) has to be coloured \fxnote*{right choiche of words?}{according to} the extension $\ext G$.
...
\fxnote{We might also want to provide a oriented version of this lemma}
