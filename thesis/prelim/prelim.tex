...
\mypar{Rotations}
  All graphs in this thesis have a fixed an embedding since triangulations are 3-connected and thus only have one planar embedding by a theorem due to Whitney\cite{Bondy2008}. \fxnote{What about plane triangulated graphs, art those 3connected?}
