...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{\graphname}
    \end{subfigure}
    \qquad \qquad  \qquad \qquad %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
...
\newcommand{\graphname}{KustersSimple}
\figline 

\renewcommand{\graphname}{KustersDouble}
\figline 

\renewcommand{\graphname}{KustersChord}
\figline

2-6 is not a possible edge since then (264) would be a irreducible triangle.
